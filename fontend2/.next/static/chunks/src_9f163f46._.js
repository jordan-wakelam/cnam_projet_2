...
async function login(email, password) {
    try {
        ...
        return {
            success: false,
            message: data.msg || 'Échec de connexion'
        };
    } catch (error) {
        return {
            success: false,
...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(email, password);
        if (result.success) {
...
//# sourceMappingURL=src_9f163f46._.js.map